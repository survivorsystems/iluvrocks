export const mockRockhoundProfile = {
  user: {
    id: 'dev-user',
    ...
    bio: 'Weekend rockhound building a field notebook for careful collecting, shared knowledge, and a little bit of dirt-under-the-fingernails joy.',
    avatarInitials: 'KS',
  },
  stats: [
  ...
  rockhoundCard: {
    ...
    style: 'Beach walks, river bars, old road cuts',
    kit: 'Loupe, field notebook, GPS pins, canvas pouch',
  ...
  bucketList: [
    ...
    'Visit a verified Ellensburg Blue public access area',
    'Create a beachcombing safety checklist',
    'Photograph every keeper with scale and notes',
  ],
  progress: [
    { label: 'Agates', current: 42, total: 60 },
    { label: 'Jasper', current: 27, total: 40 },
    { label: 'Quartz', current: 18, total: 25 },
  ],
  reputation: [
    { label: 'Helpful IDs', value: '34' },
    { label: 'Location updates', value: '11' },
