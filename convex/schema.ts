...
export default defineSchema({
  ...
  siteAppearance: defineTable({
    ...
    searchBarBackgroundColor: v.optional(v.string()),
    searchBarTextColor: v.optional(v.string()),
    searchBarBorderColor: v.optional(v.string()),
    searchBarButtonBackgroundColor: v.optional(v.string()),
    searchBarButtonTextColor: v.optional(v.string()),
